class ErrorMessages(str):
    ...
    EDIT_MISSING_PARAMS = "чего-то не хватает. формат: /edit group day\n group - номер группы, day - число из диапазона 0-6"
...
class TextResponse(str):
    ...
    ADMIN_SELECT_DEGREE = "выберите степень: bac/mag/phd"
    ...
    ADMIN_HELP = "/pdfupd - обновить расписание\n/send_all - отправить спам всем\n/edit - поменять расписание"
