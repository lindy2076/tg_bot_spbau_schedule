...
praparentdir = os.path.dirname(parentdir)
prapraparentdir = os.path.dirname(praparentdir)
sys.path.insert(0, prapraparentdir) 

from timetable_bot.config import DefaultSettings
from timetable_bot.db import DeclarativeBase
from timetable_bot.db.models import *  
